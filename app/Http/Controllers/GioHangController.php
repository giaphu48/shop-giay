...
class GioHangController extends Controller
{
    ...
    public function update(Request $request)
    {
        ...
        $requestedQuantity = $request->so_luong;
    
        // Kiểm tra số lượng tồn kho
        if ($giay->so_luong < $requestedQuantity) {
            // Nếu số lượng yêu cầu vượt quá số lượng tồn kho, hiển thị thông báo lỗi
            return redirect('/gio-hang')->with('error', 'Sản phẩm không có đủ số lượng trong kho');
        }
    
        // Nếu số lượng đủ, cập nhật số lượng trong session của giỏ hàng
        $gio_hang[$request->id]['so_luong'] =  $requestedQuantity;
