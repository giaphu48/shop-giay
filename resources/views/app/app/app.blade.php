...
<body style="padding: 0; margin: 0;">
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
        <div class="container">
            <a class="navbar-brand me-2" href="/"><img src="{{ URL('images1/logo.png') }}" height="35" alt="Sneakers SHOP"
                    loading="lazy"></a>
    ...
    <footer class="text-center text-lg-start bg-light text-muted">
                ...
                <div class="row mt-3">
                    <div class="col-md-4 col-lg-3 col-xl-3 mx-auto mb-md-0 mb-4">
                        ...
                        <p>
                            ...
                            phub2110138@student.ctu.edu.vn
                        </p>
                    ...
                    <div class="col-md-2 col-lg-2 col-xl-2 mx-auto mb-4">
                        ...
                        <p><a href="/cua-hang" class="text-reset"><i class="fas fa-angle-right"></i>&nbsp;Cửa hàng</a>
                        </p>
        ...
        <section class=" justify-content-center justify-content-lg-between p-4 border-top"
            ...
            <div class="text-center me-5 d-none d-lg-block">
                <span class="text-center text-white">© 2023 Bản quyền thuộc về:
                    <a class="text-white" href="/">&ensp;SNEAKERS SHOP</a>
                </span>
            </div>
        </section>
    </footer>
